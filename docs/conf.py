...
htmlhelp_basename = 'AudioCommonsservicesandAPIdocumentation'
...
latex_documents = [
    (master_doc, 'AudioCommonsservicesandAPIdocumentation.tex', 'Audio Commons services and API documentation',
     'Audio Commons consortium', 'manual'),
]
...
man_pages = [
    (master_doc, 'AudioCommonsservicesandAPIdocumentation', 'Audio Commons services and API documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AudioCommonsservicesandAPIdocumentation', 'Audio Commons services and API documentation',
     author, 'AudioCommonsservicesandAPIdocumentation', 'One line description of project.',
     'Miscellaneous'),
]
